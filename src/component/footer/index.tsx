...
const Footer: React.FC<FooterProps> = () => {
    return (
        ...
        <div className="w-full justify-center flex bg-[#FDF0E9] mt-5">
            <div className="sm:w-full md:w-[60rem] px-5 flex justify-between pt-5 pb-3 gap-3 flex-wrap">
                {/* Col1 */}
                <div>
                    <div className='flex'>
                    ...
                    <div className='font-Fredoka text-gray-500 text-sm text-wrap'>Continue Thong 2024 all rights reserved</div>
                    <div className='mt-5 text-red-500 tracking-wider text-3xl font-semibold font-Fredoka text-wrap'>follow us on</div>
                    <div className='flex items-center -ml-2'>
                        <div onClick={() => { window.open('https://www.instagram.com/lngo666/') }}>
                        ...
                        <div onClick={() => { window.open('https://www.facebook.com/gtl201/') }}>
                        ...
                        <div onClick={() => { window.open('https://www.tiktok.com/@lngovognl') }}>
                ...
                {/* Col 2 */}
                <div>
                    <div className='text-red-500 tracking-wider text-3xl font-semibold font-Fredoka'>Menu</div>
                    <ul className="flex flex-wrap flex-col justify-around font-Fredoka text-gray-500 text-sm">
                        <li className="mt-1 hover:text-black">Combo</li>
                        <li className="mt-1 hover:text-black">Thịt</li>
                        <li className="mt-1 hover:text-black">Đồ ăn kèm</li>
                        <li className="mt-1 hover:text-black">Nước</li>
                    </ul>
                </div>

                {/* Col 3 */}
                <div>
                    <div className='text-red-500 tracking-wider text-3xl font-semibold font-Fredoka'>Contact</div>
                    <ul className="flex flex-wrap flex-col justify-around font-Fredoka text-gray-500 text-sm">
                        <li
                            className="mt-1 hover:text-black flex gap-1 items-center text-wrap"
                        ...
                        <li
                            className="mt-1 hover:text-black flex gap-1 items-center text-wrap"
                            onClick={() => { window.location.href = "mailto:longads12001@gmail.com" }}
                        >
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-4 h-4">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M21.75 9v.906a2.25 2.25 0 0 1-1.183 1.981l-6.478 3.488M2.25 9v.906a2.25 2.25 0 0 0 1.183 1.981l6.478 3.488m8.839 2.51-4.66-2.51m0 0-1.023-.55a2.25 2.25 0 0 0-2.134 0l-1.022.55m0 0-4.661 2.51m16.5 1.615a2.25 2.25 0 0 1-2.25 2.25h-15a2.25 2.25 0 0 1-2.25-2.25V8.844a2.25 2.25 0 0 1 1.183-1.981l7.5-4.039a2.25 2.25 0 0 1 2.134 0l7.5 4.039a2.25 2.25 0 0 1 1.183 1.98V19.5Z" />
                            </svg>
                            longads12001@gmail.com
                        </li>
                        <li
                            className="mt-1 hover:text-black flex gap-1 items-center text-wrap"
                            onClick={() => { window.open('https://www.google.com/maps/place/123+%C4%90.+L%E1%BA%A1c+Long+Qu%C3%A2n,+Ngh%C4%A9a+%C4%90%C3%B4,+C%E1%BA%A7u+Gi%E1%BA%A5y,+H%C3%A0+N%E1%BB%99i,+Vietnam/@21.0490339,105.8020166,17z/data=!3m1!4b1!4m10!1m2!2m1!1s123A+Lac+Long+Quan,+Dong+Da,+Ha+Noi!3m6!1s0x3135ab1863de60d1:0x43d2fb55d36d748e!8m2!3d21.049029!4d105.80663!15sCiMxMjNBIExhYyBMb25nIFF1YW4sIERvbmcgRGEsIEhhIE5vaZIBEGdlb2NvZGVkX2FkZHJlc3PgAQA!16s%2Fg%2F11c2hz11w6?entry=ttu', '_blank') }}
                        >
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-4 h-4">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M15 10.5a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
                                <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1 1 15 0Z" />
                            </svg>
                            123D Lac Long Quan, Dong Da, Ha Noi
                        </li>
                    </ul>
                </div>
            </div>
