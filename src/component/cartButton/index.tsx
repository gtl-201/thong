...
const CardButton: React.FC<CardButtonProps> = ({ onclick }) => {
  ...
  return (
    <div onClick={onclick ? () => onclick() : () => { }}
      ...
      className="cursor-pointer z-30 fixed bottom-3 -left-1 w-fit drop-shadow-lg flex items-center rounded-r-full bg-[#EA5958] px-1 py-1 text-[#FFFCFF] transition ease-in-out hover:scale-110 duration-200"
    >
