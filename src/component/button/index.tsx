...
const Button: React.FC<ButtonProps> = ({ text, icon, bg, textSize, bgIcon, onclick }) => {
  ...
  return (
    ...
    >
      {icon ? <div style={bgIcon? {backgroundColor: bgIcon} : {backgroundColor: '#FACA62'}} className="p-1 rounded-full text-black" dangerouslySetInnerHTML={{ __html: icon }} /> : null}
      {text
        ? textSize
          ? textSize == 'sm'
